...
Original file is located at
    https://colab.research.google.com/drive/11a_Hn13KtwxKhkB-TBvHlXjJSi9urVPF

Создаем приложение с графическим интерфейсом для прогнозирования "соотношения матрица-наполнитель"
"""
...
def predict():
    ...
    return render_template('mainn.html', message=message)
